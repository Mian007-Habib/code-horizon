    ...
    >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        <div
          ...
          border border-[#313244]/50 hover:border-[#313244] border-width-2px
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div
                className="absolute top-6 right-1 z-10 flex gap-1 items-center"
                ...
                {user?.id === snippet.userId && (
                  <div className="z-10" onClick={(e) => e.preventDefault()}>
                    <button
                      ...
                      disabled={isDeleting}
                      className={`group flex items-center gap-1.5 px-2 py-1.5  rounded-lg transition-all duration-200
                                  ${
                                    isDeleting
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <pre className="relative bg-black/30 rounded-lg p-4 overflow-hidden text-sm text-gray-300 font-mono max-h-[120px] whitespace-pre-wrap break-words">
                  {snippet.code}
                </pre>
              </div>
            </div>
